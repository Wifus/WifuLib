...
/**
 * Manages payloads to and from the Gateway
 * @prop {Client} client The Client
 * @prop {String} token The Bot token
 * @prop {?WebSocket} gateway The WebSocket connection
 * @prop {Number} sequence_number The sequence number
 * @prop {String} session_id The session ID
 * @prop {?Boolean} lastHeartbeatACK Wether or not the last heartbeat was acknowledged
 * @prop {*} pulse The interval loop for sending a heartbeat. It is of type (*) because I do not know what the type of a setInterval is 
 */
